...
const AboutArea = () => {
  return (
    <section className="py-12 md:py-16 lg:py-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-0">
      {/* image */}
      ...
      <div className="pl-4 lg:pl-8 xl:pl-[60px] xl:py-12 lg:max-w-[470px] xl:max-w-[552px]">
        ...
        <h2 className="text-[32px] xl:text-[40px] lg:leading-[44px] xl:leading-[52px] font-semibold py-4">
